...
export class EliminatedModal extends LitElement {
  ...
  constructor() {
    ...
    this.id=0;
    //this.esconderDialog();
    sandbox.on('abrir-modal-adopcion',this.showDialog.bind(this));
  }
  ...
  eliminarMascota(){
    this.esconderDialog();
    sandbox.dispatch('delete-adoption',{id:this.id},this);
  }

}

customElements.define('eliminated-modal',EliminatedModal );
...
export class MascotaEliminarDialogAdopciones extends LitElement {
  ...
  eliminarMascota(){
    ...
    //console.log(this.id);
    sandbox.dispatch('delete-mascota-adopciones',{id:this.id},this);
  }

}

customElements.define('mascota-eliminar-dialog-adopciones',MascotaEliminarDialogAdopciones );